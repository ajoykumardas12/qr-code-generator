...
function EmailInput(props) {
    ...
    useEffect(() => {
        props.onInputChange("mailto:" + emailInput.to + "?subject=" + emailInput.subject + "&body=" + emailInput.body);
    })
    ...
    return (
        <form action=""  onSubmit={handleEmailInputSumbit}>
            ...
            <input type="text" name="input-for-subject" className="input" id="input-for-subject" value={emailInput.subject} onChange={handleEmailInputChange} autoComplete="off" />
            <label htmlFor="input-for-body" className="label"> Body </label>
            <input type="text" name="input-for-body" className="input" id="input-for-body" value={emailInput.body} onChange={handleEmailInputChange} autoComplete="off" />
