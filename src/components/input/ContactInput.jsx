...
function ContactInput(props) {
    ...
    useEffect(() => {
        props.onInputChange("BEGIN:VCARD\r\nVERSION:3.0\r\nN:" + contactInput.name + "\r\nFN:" + contactInput.name + "\r\nORG:" + contactInput.organization + "\r\nTEL;TYPE=cell:" + contactInput.mobile + "\r\nTEL;TYPE=TEL:" + contactInput.phone + "\r\nEMAIL;PREF;INTERNET:" + contactInput.email + "\r\nURL:" + contactInput.website + "\r\nADR:;;"+ contactInput.street +";"+ contactInput.city +";"+ contactInput.district +";"+ contactInput.postalCode +";"+ contactInput.country +"\r\nEND:VCARD");
    })
    ...
    function handleContactInputSumbit(event){
        ...
        if(contactInput.name || contactInput.mobile || contactInput.phone || contactInput.email || contactInput.organization || contactInput.website || contactInput.street || contactInput.city || contactInput.district || contactInput.postalCode || contactInput.country){
            props.onGenerate();
        };
    }
    ...
    return (
        <form action=""  onSubmit={handleContactInputSumbit} className="contact-input">
            ...
            <label htmlFor="input-for-website" className="label"> Website </label>
            <input type="text" name="input-for-website" className="input" id="input-for-website" value={contactInput.website} onChange={handleContactInputChange} autoComplete="off" />
            <label htmlFor="input-for-street" className="label"> Street </label>
            <input type="text" name="input-for-street" className="input" id="input-for-street" value={contactInput.street} onChange={handleContactInputChange} autoComplete="off" />
            <label htmlFor="input-for-city" className="label"> City </label>
            <input type="text" name="input-for-city" className="input" id="input-for-city" value={contactInput.city} onChange={handleContactInputChange} autoComplete="off" />
            <label htmlFor="input-for-district" className="label"> District </label>
            <input type="text" name="input-for-district" className="input" id="input-for-district" value={contactInput.district} onChange={handleContactInputChange} autoComplete="off" />
            <label htmlFor="input-for-postal-code" className="label"> Postal Code </label>
            <input type="text" name="input-for-postal-code" className="input" id="input-for-postal-code" value={contactInput.postalCode} onChange={handleContactInputChange} autoComplete="off" />
            <label htmlFor="input-for-country" className="label"> Country </label>
            <input type="text" name="input-for-country" className="input" id="input-for-country" value={contactInput.country} onChange={handleContactInputChange} autoComplete="off" />
